...
3. Walk the user through Chrome:
   ...
   6. Open x.com, linkedin.com, or reddit.com and scroll. Every post of 5 or more words gets a small `AI 12%` line under it. Posts over the threshold collapse to `Likely AI · 88% [Show]`.
